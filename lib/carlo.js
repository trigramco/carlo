...
class App extends EventEmitter {
  ...
  async targetCreated_(target) {
    this.targetCounter_++;
    if (this.targetCounter_ >= maxNumTargets) {
      debugApp('Not attaching Carlo to a newly created target because the maximum configured number of targets has been reached');
      return;
    }
...
class Window extends EventEmitter {
  ...
  async init_() {
    ...
    await Promise.all([
      ...
      this.page_.target()._targetInfo.type === 'page'
